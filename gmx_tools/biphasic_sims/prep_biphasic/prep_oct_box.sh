...
cp -r ./../../../../deriveFF+box/ref/oct_box/amber99sb-ildn.ff/ .
cp ./../../../../deriveFF+box/ref/$MOL.top .
cp ./../../../../deriveFF+box/ref/$MOL.gro .
cp ./../../../../deriveFF+box/octanol/oct.gro .
cp ./../../../../deriveFF+box/octanol/oct.top .
...
## Checking if minimization works with grompp and running equilibration of oct box
